        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          {cohort ? (
            <div className="flex flex-col items-center">
              ...
              <div className="border border-green-200 rounded-lg p-6 mb-8 w-full">
                <h2 className="text-xl font-semibold mb-3">Complete Your Registration!</h2>
                <p className=" mb-4">
                Ensure you fill out this form for final onboarding 

You will receive an email after you submit, this form is crucial for accessing the class resources
                </p>
                <a
                  href={formLink}
                  target="_blank"
